...
TRANSLATIONS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "dashboard.save_search": "Save this search for daily email alerts",
        "dashboard.saved_searches_title": "Your saved searches",
    ...
    "es": {
        ...
        "dashboard.save_search": "Guardar esta búsqueda para alertas diarias por email",
        "dashboard.saved_searches_title": "Tus búsquedas guardadas",
    ...
    "fr": {
        ...
        "dashboard.save_search": "Enregistrer cette recherche pour des alertes email quotidiennes",
        "dashboard.saved_searches_title": "Vos recherches enregistrées",
    ...
    "de": {
        ...
        "dashboard.save_search": "Diese Suche für tägliche E-Mail-Benachrichtigungen speichern",
        "dashboard.saved_searches_title": "Deine gespeicherten Suchen",
    ...
    "it": {
        ...
        "dashboard.save_search": "Salva questa ricerca per avvisi email giornalieri",
        "dashboard.saved_searches_title": "Le tue ricerche salvate",
